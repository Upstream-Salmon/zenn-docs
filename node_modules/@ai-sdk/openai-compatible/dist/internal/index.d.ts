...
type OpenAICompatibleContentPart = OpenAICompatibleContentPartText | OpenAICompatibleContentPartImage | OpenAICompatibleContentPartVideo | OpenAICompatibleContentPartInputAudio | OpenAICompatibleContentPartFile;
...
interface OpenAICompatibleContentPartVideo extends JsonRecord {
    type: 'video_url';
    video_url: {
        url: string;
    };
...
declare function convertToOpenAICompatibleChatMessages(prompt: LanguageModelV4Prompt, { providerOptionsKey }?: {
...
} | undefined | null): LanguageModelV4Usage;

declare function mapOpenAICompatibleFinishReason(finishReason: string | null | undefined): LanguageModelV4FinishReason['unified'];

declare function getResponseMetadata({ id, model, created, }: {
    id?: string | null;
    model?: string | null;
    created?: number | null;
}): _ai_sdk_provider.LanguageModelV4ResponseMetadata;
