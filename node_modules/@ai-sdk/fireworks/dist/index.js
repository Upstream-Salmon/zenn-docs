...
var FireworksImageModel = class _FireworksImageModel {
  ...
  async pollForImageUrl({
    ...
    const pollingAbortSignal = abortSignal == null ? timeoutController.signal : AbortSignal.any([abortSignal, timeoutController.signal]);
    try {
      while (true) {
